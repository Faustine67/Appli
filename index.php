...
<nav class="d-flex flex-row justify-content-end" class="navbar navbar-light" style="background-color: #e3f2fd;">
	<a class="p-2 text-dark " style=" text-decoration:none " href="index.php">Ajout Article</a>
	<a class="p-2 text-dark font-weight-bold" style=" text-decoration:none" href="recap.php"> Mon Panier </a>
</nav>
